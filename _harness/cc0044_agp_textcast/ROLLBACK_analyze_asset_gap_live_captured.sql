-- ROLLBACK ARTIFACT — byte-exact capture of the LIVE public.analyze_asset_gap body
-- Captured 2026-07-20 from pg_get_functiondef(public.analyze_asset_gap(text,text,text,text))
-- project mbkmaxqhsohbtwsqolns. Restores the pre-fix (buggy bare-literal append) function verbatim.
-- prosrc md5 d3578bd0e4498c31b2ea6ebf1c13538b, length 6276.
