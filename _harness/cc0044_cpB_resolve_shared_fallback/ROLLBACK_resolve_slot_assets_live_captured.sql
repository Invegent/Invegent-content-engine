-- ROLLBACK ARTIFACT — byte-exact capture of the LIVE public.resolve_slot_assets body
-- Captured 2026-07-20 from pg_get_functiondef(public.resolve_slot_assets(text,text,text,uuid,text))
-- project mbkmaxqhsohbtwsqolns. This restores the pre-cc-0044-CpB function verbatim.
-- Apply this exact statement to roll back the v1.2 shared-pool-fallback migration.
