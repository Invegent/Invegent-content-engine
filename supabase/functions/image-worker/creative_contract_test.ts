...
// "the constant dies", D5). The contract's fixed-logo binding is pinned with a literal
// instead of cross-checking retired runtime constants.
//
...
// 'resolve_slot_assets', NO asset_keys). The absence of asset_keys is the load-bearing
// property; contract_version STAYS 'v2' (the field is an inert annotation, never stamped).
