// creative_contract.ts — ACI Foundation v0 / Slice B1 (ai-worker; vendored per-worker copy).
//
...
export const PP_IMAGE_QUOTE_NEWS_CARD_V1: CreativeContract = Object.freeze({
  ...
  fields: Object.freeze({
    ...
    renderer_fixed: Object.freeze([
      ...
      // (Vendored sync 2026-08-03, WS-5 P1 lane: re-synced from the canonical
      // image-worker/creative_contract.ts @ 2b71d23 — the parity test caught this copy stale.)
