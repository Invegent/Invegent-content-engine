-- RECONSTRUCTED 2026-05-25 from supabase_migrations.schema_migrations (version 20260524091020),
...
-- NOTE: presence of this APPLIED migration is the evidence that cc-0019 IS implemented,
-- correcting sync_state v3.05's 'brief only, NOT implemented' claim.
...
-- D-01 sql_destructive: a2e5f3f5-b712-4ab2-a463-7b40d3cd151f (agree). PK approved.
