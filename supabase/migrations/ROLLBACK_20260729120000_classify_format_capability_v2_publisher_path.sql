...
-- =====================================================================
-- Reverses 20260729120000_classify_format_capability_v2_publisher_path.sql by
-- re-applying (CREATE OR REPLACE) the exact PRIOR live body of
-- public.classify_format_capability — byte-identical to the function body in
-- supabase/migrations/20260728034955_classify_format_capability_v1.sql (the
-- version applied and live before the publisher-path-missing extension).
--
-- This is how a CREATE OR REPLACE FUNCTION is rolled back: there is no DROP
-- here (the function existed and was in use before this migration too) — the
-- rollback simply restores the six-status body, removing the new
-- publisher_path_missing precedence check and its COMMENT/evidence text.
--
-- Restores to: supabase/migrations/20260728034955_classify_format_capability_v1.sql
-- =====================================================================
