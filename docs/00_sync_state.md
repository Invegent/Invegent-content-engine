...
Carries: cc-0015 (Wave 7, gated on Gate 11 2026-05-26); cc-0016 Stage E (future/separately-approved); **Q-005 (OPEN, next-fire watch; brief v3.1.1)**; **YT backlog drain watch / YT token durability / CFW+Invegent YT onboarding / F-YT-FAILED-NO-RETRY brief (AUTHORED + plan_review CLEAN v3.06) / F-YT-EXPIRY-DISPLAY-FAKE cleanup / cc-0019 Unit B optional (Unit A implemented)**; cc-0017c v1.2 doc patch; cc-0017a v1.2 doc patch; vchecks.md V-B4 doc patch; minor doc patches; F-CRON-AUTO-APPROVER-SECRET-INLINE; backend/shared-metrics refactor (deferred); lesson promotions (L-v2.83-a STRONG 18+; **L-v2.85-e PROMOTION-CONFIRMED**; L-v2.85-a HIGH-SIGNAL 4 occurrences; L62 strongly reinforced; L-v2.88-a watcher; **L-v2.94 convention NEW candidate**; **L-v3.02-a / L-v3.03-a / L-v3.04-a NEW candidates**; **L-v3.05-a NEW candidate — record the root CAUSE not just the symptom**; **L-v3.06-a NEW candidate — verify deployed-vs-repo state before redeploy + backfill chat-applied migrations same-session**; **L41 re-exercised v3.02.1 + reinforced v3.03/v3.04/v3.05/v3.06**; L-v2.90-a-f watchers).
...
- **L41**: **re-exercised v3.02.1**, reinforced v3.02.2/v3.03/v3.04, **reinforced v3.05 + v3.06** (session files new; sync_state + action_list patched read-HEAD-first with sha passed). Strong negative-then-positive exemplar.
