...
**Status:** DRAFT — first implementation tranche built + first run recorded 2026-08-08; NOT wired to any hook/cron (wiring is a future PK gate); uncommitted pending PK review.
