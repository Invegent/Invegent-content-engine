...
> ⚠️ **ARCHIVED 21 Apr 2026.** This file is a frozen point-in-time snapshot from 6 April 2026 that was never overwritten because the Cowork-hosted nightly reconciler stopped running after 3 April. Treat as historical only. Authoritative current state lives in `docs/00_sync_state.md`.
