> ## 📌 LANDED ON MAIN 2026-07-24 — docs-only reconciliation (governance landing gate)
> **Provenance:** byte-exact copy from branch **`origin/claude/new-session-swx6cf`**, close commit
> **`198a841`** (2026-07-23T00:52:27Z); register lineage **v6.11** (`2c5a503`). Never merged before now.
> **Canonical ID `cc-0047` — CONFIRMED by PK ruling 2026-07-24.** This is the PK-ACCEPTED planning
> artifact; it authorises no implementation. Its named next slice (exec_sql → typed resolver) was
> subsequently attempted, deployed, caused an outage and was rolled back — see canonical **`cc-0052`**
> (`docs/briefs/results/cc-0052-heygen-typed-resolver-incident-result-v1.md`). **Read that before
> acting on the "named next slice" paragraph in this document.**
> Ledger: `docs/briefs/results/governance-recovery-lane-2026-07-24-result-v1.md` §3/§4.
