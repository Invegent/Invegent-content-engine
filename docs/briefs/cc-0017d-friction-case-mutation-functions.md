...
**Brief ID:** cc-0017d
**Version:** v1.0
**Status:** AUTHORED_PENDING_D01 (no production mutations during authoring)
**Wave:** 0d of 10 (Friction Register Consolidation Plan v1)
**Authored:** 2026-05-19 Sydney morning (session v2.86)
...
| Section | File | Covers |
|---|---|---|
| 1-2 | (this file) | Strategic anchor + scope |
| 3-4 | `cc-0017d/risks-and-grants.md` | Risks + function-level grant matrix |
| 5.1 | `cc-0017d/preflight-pset.md` | P-set queries (re-run before apply) |
| 5.2 | `cc-0017d/migration-sql.md` | 6 CREATE OR REPLACE FUNCTION + GRANTs |
| 5.3 | `cc-0017d/vchecks.md` | V-A1 through V-Z1 (≈30 V-checks) |
| 5.4-5.5 | `cc-0017d/hardstop-rollback.md` | Hard-stop matrix + DROP FUNCTION rollback |
| 6-8 | `cc-0017d/d01-postapply-deferred.md` | D-01 framing + post-apply commitments + deferred items |
| 9-11 | `cc-0017d/lessons-metadata-changelog.md` | Lessons + metadata + changelog |
...
- **Loose `resolve_case`** (any resolution_kind for any action_decision) — strict mapping is cleaner audit and forces operator intent to be explicit; can be relaxed in v1.1 if PK directs.
