...
> **Provenance:** byte-exact copy of `docs/briefs/cc-0047-agp-v2-identity-resolution-planning.md`
> from branch **`origin/claude/new-session-swx6cf`**, brief commit **`191db5f`** lineage, lane closed
> by **`198a841`** (2026-07-23T00:52:27Z). That branch diverged from `194e43e` (register v6.10) and
> was never merged.
> **Canonical ID `cc-0047` — CONFIRMED by PK ruling 2026-07-24** (earliest committed claim keeps the
> number). The competing uncommitted lane renumbered to `cc-0051`.
> **Landed docs-only.** No cc-0052 implementation code was reintroduced with this document.
