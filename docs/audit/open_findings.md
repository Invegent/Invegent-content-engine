...
**Status:** OPEN — Phase 1 (5 GREEN), Phase 1b (`store_linkedin_org_token` search_path), the `upsert_publish_profile` revoke, Phase 2 Batch-1 (6 pipeline/notifier/crosspost RPCs), and Phase 2 Batch-2 (9 internal-writer RPCs) all APPLIED + VERIFIED (2026-06-16); remaining systemic SECURITY DEFINER surface still open.
